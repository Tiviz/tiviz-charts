...
import com.github.tiviz.ui.svg.Text;
...
public class ChartAxis<S extends Scale<S>> extends GContainer {
	...
	private int length = ChartAxis.DEFAULT_LENGTH;
	...
	public ChartAxis<S> titlePosition(final String x, final String y) {
		this.titleX = x;
		this.titleY = y;
		scheduleRedraw();
		return this;
	 ...
	 */
	public ChartAxis<S> titleRotation(final double angle) {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.github.tiviz.ui.svg.Container#redraw()
	 */
	@Override
	public void redraw() {
		super.redraw();
